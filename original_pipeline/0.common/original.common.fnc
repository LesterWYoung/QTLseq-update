...
# ##################################################			
Set_TOPPATH_SCRIPTS(){			
	TOPPATH_SCRIPTS="/disk2/analysis/qtlseq_analysis/QTL-seq_framework1.4.2/ibrc_scripts"		
	echo "${TOPPATH_SCRIPTS}"		
}			
			
Set_TOPPATH_COVAL(){			
	TOPPATH_COVAL="/home/hideko/work/framework/framework1.4.4/QTL-seq_framework1.4.4/execute_Coval/Coval-1.4"		
	echo "${TOPPATH_COVAL}"		
}			
...
Set_SRC_READ_PATH_MY_CULTIVAR(){			
	SRC_READ_PATH_MY_CULTIVAR="/home/hideko/work/framework/framework1.4.4/QTL-seq_framework1.4.4/1.qualify_read/anyname/q30p90/sep_pair"		
...
Set_PUBLIC_REF_FASTA(){			
	REF_FASTA="/disk2/analysis/qtlseq_analysis/QTL-seq_framework1.4.2/downloaded_fasta/IRGSP-1.0_genome.fasta/IRGSP-1.0_genome.fasta"		
	echo "${REF_FASTA}"		
}			
...
Set_REF_FASTA()			
{			
	REF_FASTA="/home/hideko/work/framework/framework1.4.4/QTL-seq_framework1.4.4/2.make_consensus/90.align_to_this_fasta/00.reference/anyname_q30p90_MSR_Cov_10_S-snp_RYKMSWBDHV2ACGT.fa"		
	echo "${REF_FASTA}"		
}			
...
# --------------------------------------------------			
Set_SRC_READ_PATH(){			
	SRC_READ_PATH="/home/hideko/work/framework/framework1.4.4/QTL-seq_framework1.4.4/1.qualify_read/equalized"		
...
Set_PILEUPDB_PATH()			
{			
	PILEUPDB_PATH="/home/hideko/work/framework/framework1.4.4/QTL-seq_framework1.4.4/2.make_consensus/90.align_to_this_fasta/30.coval_call"		
	echo "${PILEUPDB_PATH}"		
}			
