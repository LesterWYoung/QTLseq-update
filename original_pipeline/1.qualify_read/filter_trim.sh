...
if [ find ../parental_readfiles/* | wc -l -eq 1 ]; then		# if parental readfiles are missing and only README present
	echo "Parental readfiles are missing. Put them in ../parental_readfiles using name_R[12].fastq.gz format"
	exit
fi
